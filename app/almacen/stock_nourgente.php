  ...
  <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Materiales no urgentes por surtir</h4>
                    </div>
                    ...
                    <div class="col-12">
                         ...
                         <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Este es el listado de los articulos a surtir sin urgencia.<strong>
                                ...
                                <div class="table-responsive m-t-40">
                                    <table id="myTable" class="table table-bordered table-striped">
                                        ...
                                        <tr style="width: 79px;background: #ffe7e7;">
                                                ...
                                                <th style="width: 64px;background: #000;font-weight: 700;color: #fff;">Existencia</th>
