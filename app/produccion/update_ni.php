                                                ...
                                                <td class="clasetd  text-center " colspan="3">
                                                     <div class="input-group">
                                                        <ul class="icheck-list">
                                                            <li>
                                                                <input type="checkbox" name="impulsor" value="impulsor" class="check">
                                                                <label for="square-checkbox-1">Impulsor</label>
                                                            </li>
                                                        </ul>
                                                        <ul class="icheck-list">
                                                            <li>
                                                                <input type="checkbox" name="salida" value="salida" class="check">
                                                                <label for="square-checkbox-1">salida</label>
                                                            </li>
                                                        </ul>
                                                        <ul class="icheck-list">
                                                            <li>
                                                                <input type="checkbox" name="munones" value="munones" class="check">
                                                                <label for="square-checkbox-1">muñones</label>
                                                            </li>
                                                        </ul>
                                                        <ul class="icheck-list">
                                                            <li>
                                                                <input type="checkbox" name="ranura" value="ranura" class="check">
                                                                <label for="square-checkbox-1">Ranura</label>
                                                            </li>
                                                        </ul>
                                                        <ul class="icheck-list">
                                                            <li>
                                                                <input type="checkbox" name="altura" value="altura" class="check">
                                                                <label for="square-checkbox-1">Altura</label>
                                                            </li>
                                                        </ul>
                                            ...
                                            <!-- //////////////////////////////////////////////////////////////////////-->
                                                ...
                                                <td class="clasetd  text-center " colspan="3">
                                                    <div class="input-group">
                                                        <ul class="icheck-list">
                                                            <li>
                                                                <input type="checkbox" name="entrada" value="entrada" class="check">
                                                                <label for="square-checkbox-1">Entrada</label>
                                                            </li>
                                                        </ul>
                                                        <ul class="icheck-list">
                                                            <li>
                                                                <input type="checkbox" name="salidacom" value="salida" class="check">
                                                                <label for="square-checkbox-1">Salida</label>
                                                            </li>
                                                        </ul>
                                                        <ul class="icheck-list">
                                                            <li>
                                                                <input type="checkbox" name="alturacom" value="altura" class="check">
                                                                <label for="square-checkbox-1">Altura</label>
                                                            </li>
                                                        </ul>
                                            ...
                                            <!-- //////////////////////////////////////////////////////////////////////-->
                                                ...
                                                <td class="clasetd  text-center " colspan="3">
                                                     <div class="input-group">
                                                        <ul class="icheck-list">
                                                            <li>
                                                                <input type="checkbox" name="alineacion" value="barrenar" class="check">
                                                                <label for="square-checkbox-1">Alineacion</label>
                                                            </li>
                                                        </ul>
                                                        <ul class="icheck-list">
                                                            <li>
                                                                <input type="checkbox" name="balanceo" value="soldar" class="check">
                                                                <label for="square-checkbox-1">Balanceo</label>
                                                            </li>
                                                        </ul>
                                            ...
                                            <!-- //////////////////////////////////////////////////////////////////////-->
                                                ...
                                                <td class="clasetd  text-center " colspan="3">
                                                   <div class="input-group">
                                                        <ul class="icheck-list">
                                                            <li>
                                                                <input type="checkbox" name="ceja" value="ceja" class="check">
                                                                <label for="square-checkbox-1">Ceja</label>
                                                            </li>
                                                        </ul>
                                                        <ul class="icheck-list">
                                                            <li>
                                                                <input type="checkbox" name="rosca" value="rosca" class="check">
                                                                <label for="square-checkbox-1">Rosca</label>
                                                            </li>
                                                        </ul>
                                                        <ul class="icheck-list">
                                                            <li>
                                                                <input type="checkbox" name="dia_sello" value="Dia Sello" class="check">
                                                                <label for="square-checkbox-1">Dia sello</label>
                                                            </li>
                                                        </ul>
                                                        <ul class="icheck-list">
                                                            <li>
                                                                <input type="checkbox" name="dia_cama" value="Dia camas" class="check">
                                                                <label for="square-checkbox-1">Dia camas</label>
                                                            </li>
                                                        </ul>
                                          ...
                                          <!-- //////////////////////////////////////////////////////////////////////-->
                                            <tr>
                                                ...
                                                <td class="clasetd  text-center " colspan="3">
                                                    <div class="input-group">
                                                        <ul class="icheck-list">
                                                            <li>
                                                                <input type="checkbox" name="long" value="long" class="check">
                                                                <label for="square-checkbox-1">Long</label>
                                                            </li>
                                                        </ul>
                                                        <ul class="icheck-list">
                                                            <li>
                                                                <input type="checkbox" name="barreno" value="barreno" class="check">
                                                                <label for="square-checkbox-1">Barreno</label>
                                                            </li>
                                                        </ul>
                                                        <ul class="icheck-list">
                                                            <li>
                                                                <input type="checkbox" name="dia_int" value="Dia INT" class="check">
                                                                <label for="square-checkbox-1">Dia int</label>
                                                            </li>
                                                        </ul>
                                                        <ul class="icheck-list">
                                                            <li>
                                                                <input type="checkbox" name="diaext" value="Dia ext" class="check">
                                                                <label for="square-checkbox-1">Dia ext</label>
                                                            </li>
                                                        </ul>
                                                          <ul class="icheck-list">
                                                            <li>
                                                                <input type="checkbox" name="totalext" value="Total EXT" class="check">
                                                                <label for="square-checkbox-1">Total EXT</label>
                                                            </li>
                                                        </ul>
                                                          <ul class="icheck-list">
                                                            <li>
                                                                <input type="checkbox" name="totalint" value="Total INT" class="check">
                                                                <label for="square-checkbox-1">Total INT</label>
                                                            </li>
                                                        </ul>
                                            ...
                                            <tr>
                                                ...
                                                <td class="clasetd  text-center " colspan="3">
                                                     <div class="input-group">
                                                        <ul class="icheck-list">
                                                            <li>
                                                                <input type="checkbox" name="unoalt" value="1ALT" class="check">
                                                                <label for="square-checkbox-1">1ALT</label>
                                                            </li>
                                                        </ul>
                                                        <ul class="icheck-list">
                                                            <li>
                                                                <input type="checkbox" name="dosalt" value="2ALT" class="check">
                                                                <label for="square-checkbox-1">2ALT</label>
                                                            </li>
                                                        </ul>
                                                        <ul class="icheck-list">
                                                            <li>
                                                                <input type="checkbox" name="tresalt" value="3ALT" class="check">
                                                                <label for="square-checkbox-1">3ALT</label>
                                                            </li>
                                                        </ul>
                                                        <ul class="icheck-list">
                                                            <li>
                                                                <input type="checkbox" name="diametros" value="diametros" class="check">
                                                                <label for="square-checkbox-1">diametros</label>
                                                            </li>
                                                        </ul>
                                            ...
                                            <tr>
                                                ...
                                                <td class="clasetd  text-center " colspan="3">
                                                     <div class="input-group">
                                                        <ul class="icheck-list">
                                                            <li>
                                                                <input type="checkbox" name="toleranciaca" value="tolerancia" class="check">
                                                                <label for="square-checkbox-1">Tolerancia</label>
                                                            </li>
                                                        </ul> 
                                                    </div>
                                                    <strong>
                                            ...
                                            <tr>
                                                ...
                                                <td rowspan="11" colspan="4">
                                                 <textarea type="text" name="obsfinal" rows="18" class="form-control"></textarea>
                                                </td>
                                             </tr>  
